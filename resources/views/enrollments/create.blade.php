    ...
    <div class="max-w-2xl mx-auto px-4 py-8">
        ...
        <form action="{{ route('enrollments.store') }}" method="POST" class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 md:p-8 space-y-5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-3 pt-2">
                <button class="inline-flex items-center justify-center bg-blue-600 text-black px-6 py-3 rounded-lg shadow-sm hover:bg-blue-700 font-semibold text-sm">Save Enrollment</button>
