    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isTeacher())
                <a href="{{ route('courses.create') }}" class="inline-flex items-center justify-center bg-blue-600 text-white px-6 py-3 rounded-lg shadow-sm hover:bg-blue-700 font-semibold text-sm">
                    + Add Course
                </a>
            @endif
        </div>
